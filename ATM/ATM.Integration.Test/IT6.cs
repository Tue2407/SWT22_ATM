...
//Vi starter med systemets CalcCourse beliggenhed er i bunden til højre og på tredje række af dependency diagrammet
//CalcDistance har 2 dependencies, Integrationsmæssigt så bliver den brugt til at få kursen på flyet imellem Update og TrackData.
//Indholdsmæssigt har den koordinator og tidsdifferencen mellem 2 tracks og bruger disse værdier til at beregne kursen.
//Selve Testen forgår fra CalcCourse om den virker med den 1 integrationsdele TrackData.
...
namespace ATM.Integration.Test
{
    ...
    public class IT6
    {
        ...
        {
            _Update.Course.Calculate(_Track1, _Track2);
            _Update.Course.Received().Calculate(_Track1, _Track2);
        }
